...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
    ...
    if [[ "$distro" == "arch" || "$id_like" == "arch" ]]; then
       ...
       sudo pacman -S --needed unace unrar zip unzip p7zip sharutils uudeview arj cabextract file-roller dtc xz python3-pip python-pip brotli lz4 gawk libmpack aria2 --break-system-packages
       #aur=rar
    else
    ...
    pip install backports.lzma protobuf pycrypto --break-system-packages
